...
<footer class="footer">
            ...
            <div class="footer__widgets">
                <div class="footer__widgets-item">
                    ...
                    <span class="footer__widgets-text">
                        آکادمی آموزش برنامه نویسی آسان کد به عنوان یک آکادمی خصوصی فعالیت میکنه و این به این معنی هست که هر مدرسی اجازه تدریس در اون رو نداره 
                    </span>
                </div>
        ...
        <div class="footer__copyright">
            <p class="footer__copyright-text">کلیه حقوق برای آکادمی آسان محفوظ است.</p>
            <span class="footer__coptyright-subtext">@hossein.front.js</span>
        </div>
    </footer>
`
